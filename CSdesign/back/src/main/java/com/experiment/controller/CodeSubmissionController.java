...
public class CodeSubmissionController {
    ...
    public Result<Map<String, Object>> runCode(@RequestBody Map<String, Object> request) {
        try {
            ...
            log.info("语言ID类型: {}, 值: {}", languageId.getClass().getName(), languageId);
            ...
            log.info("代码运行完成，状态: {}", result.get("status"));
    ...
    public Result<String> testConnection() {
        try {
            ...
            log.error("Judge0 连接失败", e);
            return Result.error("Judge0 连接失败: " + e.getMessage());
        }
    }
}
