<template>
  <el-dialog 
    ...
    <el-tabs v-model="activeTab" type="border-card">
      <!-- 生成实验指导书 -->
      <el-tab-pane label="生成实验指导书" name="generate">
        <el-form :model="form" label-width="120px" style="max-width: 800px; margin: 20px auto;">
      ...
      <el-tab-pane label="历史记录" name="history">
        <div class="records-list" style="padding: 20px;">
